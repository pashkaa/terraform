...
const AddPost = ({ contacts, addContact }) => {
  ...
  return (
    <div className="container-fluid">
      <h1 className="text-center text-dark">Add Post</h1>
      <div className="row">
        <div className="col-md-6 p-5 mx-auto shadow">
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              <input className="form-control" type="text" placeholder="Full name" value={name} onChange={(e) => setName(e.target.value)}/>
            </div>
            <div className="form-group">
